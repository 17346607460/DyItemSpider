...
for page in range(1, 101):
    ...
    with open(r'C:\Users\lianqinglongfei\Desktop\DyItemSpider\web\web55\web55.js', 'r', errors='ignore') as r:
        b = r.read()
    signature = execjs.compile(b).call('get_msg', response['result'])
    datas = json.loads(signature)
