...
function sign(l, m) {
    ...
    _0x1ce8[62] != typeof __dirname && (_0xfec9xd = _0x1ce8[60]),
    {
        "\x58\x2D\x73": function(d) {
            ...
            ;return _0xfec9xe
        }(_0xfec9x6([_0xfec9xe, "test", l, m].join(''))),
...
// 1653647779934test/api/leona/rtb/data/report{"vSellerId": "5f0ea4f8a7b903000179140a", "columns": ["campaignName", "campaignId", "marketingTarget", "placement", "optimizeTarget", "biddingStrategy", "promotionTarget", "jumpType", "itemId", "fee", "impression", "click", "ctr", "acp", "cpm"], "splitColumns": ["marketingTarget", "placement", "optimizeTarget", "biddingStrategy", "promotionTarget", "jumpType", "itemId"], "needTotal": true, "needList": true, "needSize": true, "timeUnit": "DAY", "pageSize": 10, "pageNum": 1, "sorts": [], "reportType": "CAMPAIGN", "startDate": "2022-05-26", "endDate": "2022-05-26", "filters": []}
// sign('/api/leona/session', "{\"ticket\":\"ST-b138761115ec82e93984920600777b7a\",\"clientId\":\"https://ad.xiaohongshu.com\"}")